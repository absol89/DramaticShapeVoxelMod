...
TEMPLATES = {
    "bike_display_floor": dict(bicycle="floor",tileset="club",tiles=[[11,12,14],[27,28,9]],
        roof_rows=0,roof_back=0,roof_front=0,roof_cycle=(0,0),slab=0,front_eave=0,depth=16,panes=False),
    "bike_display_wall": dict(bicycle="wall",tileset="club",tiles=[[1,2,3],[17,18,19]],
        roof_rows=0,roof_back=0,roof_front=0,roof_cycle=(0,0),slab=0,front_eave=0,depth=16,panes=False),
    'gate_stool': {'front_eave': 0,
 'panes': False,
 'parts': [{'depth': 11,
            'facade': [11, 15],
            'kind': 'upright',
            ...
            'x': [2, 13],
            'z': 3},
           {'at': 4, 'kind': 'flat', 'rows': [5, 5], 'x': [3, 12], 'z': 13},
           {'at': 4, 'kind': 'flat', 'rows': [6, 6], 'x': [3, 12], 'z': 4},
           {'at': 4, 'kind': 'flat', 'rows': [7, 7], 'x': [5, 10], 'z': 6},
           {'at': 4, 'kind': 'flat', 'rows': [10, 10], 'x': [5, 10], 'z': 11}],
 'roof_back': 0,
 'roof_cycle': [0, 0],
 'roof_front': 0,
 'roof_rows': 0,
 ...
 'tiles': [[2, 3], [18, 19]],
 'tileset': 'gate'},
    'ship_cabin_table': {'tiles': [[9, 10, 10, 12], [25, 26, 44, 28], [11, 11, 11, 11]],
 'roof_rows': 0,
 'roof_cycle': [0, 0],
 'slab': 0,
 'depth_px': 17,
 'panes': False,
 'ground_tiles': [[29, 13], [13, 29]],
 'parts': [{'kind': 'flat', 'x': [0, 31], 'rows': [0, 16], 'z': 0, 'at': 11},
           {'kind': 'flat', 'x': [0, 0], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [31, 31], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 17], 'z': 0, 'at': 10, 'sample': [1, 17]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 17], 'z': 0, 'at': 9, 'sample': [0, 16]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 4], 'z': 2, 'at': 8, 'thick': 9, 'sample': [1, 17]},
           {'kind': 'flat',
            'x': [2, 5],
            'rows': [1, 4],
            'z': 11,
           ...
           {'kind': 'flat',
            ...
            'sample': [10, 9]}],
 'tileset': 'ship'},
    'ship_house_table': {'tiles': [[9, 10, 10, 12], [25, 26, 44, 28], [25, 44, 44, 28], [11, 59, 60, 11]],
 'roof_rows': 0,
 'roof_cycle': [0, 0],
 'slab': 0,
 'depth_px': 25,
 'panes': False,
 'ground_tiles': [[13, 29], [29, 13]],
 'parts': [{'kind': 'flat', 'x': [0, 31], 'rows': [0, 24], 'z': 0, 'at': 11},
           {'kind': 'flat', 'x': [0, 0], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [31, 31], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 25], 'z': 0, 'at': 10, 'sample': [1, 25]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 25], 'z': 0, 'at': 9, 'sample': [0, 24]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 4], 'z': 2, 'at': 8, 'thick': 9, 'sample': [1, 25]},
           {'kind': 'flat',
            'x': [2, 5],
            'rows': [1, 4],
            'z': 19,
           ...
           {'kind': 'flat',
            ...
            'sample': [10, 9]}],
 'tileset': 'ship'},
    'ship_captain_desk': {'tiles': [[9, 10, 10, 10, 10, 12],
           [25, 44, 68, 69, 44, 28],
           [25, 44, 44, 44, 44, 28],
           [59, 60, 11, 11, 59, 60]],
 'roof_rows': 0,
 ...
 'panes': False,
 'ground_tiles': [[13, 29], [29, 13]],
 'parts': [{'kind': 'flat', 'x': [0, 47], 'rows': [0, 24], 'z': 0, 'at': 11},
           {'kind': 'flat', 'x': [0, 0], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [47, 47], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [0, 47], 'rows': [1, 25], 'z': 0, 'at': 10, 'sample': [1, 25]},
           {'kind': 'flat', 'x': [0, 47], 'rows': [1, 25], 'z': 0, 'at': 9, 'sample': [0, 24]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 4], 'z': 2, 'at': 8, 'thick': 9, 'sample': [1, 25]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 4], 'z': 19, 'at': 8, 'thick': 9, 'sample': [1, 25]},
           {'kind': 'flat', 'x': [42, 45], 'rows': [1, 4], 'z': 2, 'at': 8, 'thick': 9, 'sample': [1, 25]},
           {'kind': 'flat', 'x': [42, 45], 'rows': [1, 4], 'z': 19, 'at': 8, 'thick': 9, 'sample': [1, 25]},
           {'kind': 'upright',
            'x': [0, 15],
            'top': [25, 25],
            'facade': [25, 31],
           ...
           {'kind': 'upright',
            ...
            'case': {'sample': [33, 27]}}],
 'tileset': 'ship'},
    'ship_kitchen_table': {'tiles': [[9, 10, 10, 12],
           [25, 26, 44, 28],
           [25, 64, 65, 28],
           [25, 80, 81, 28],
           [25, 44, 26, 28],
 ...
 'panes': False,
 'ground_tiles': [[13, 29], [29, 13]],
 'parts': [{'kind': 'flat', 'x': [0, 31], 'rows': [0, 88], 'z': 0, 'at': 11},
           {'kind': 'flat', 'x': [0, 0], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [31, 31], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 89], 'z': 0, 'at': 10, 'sample': [1, 89]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 89], 'z': 0, 'at': 9, 'sample': [0, 88]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 4], 'z': 2, 'at': 8, 'thick': 9, 'sample': [1, 89]},
           {'kind': 'flat',
            'x': [2, 5],
            'rows': [1, 4],
            'z': 83,
           ...
           {'kind': 'flat',
            ...
            'sample': [18, 65]}],
 'tileset': 'ship'},
    'ship_bunk': {'tiles': [[70, 71], [86, 87], [86, 87], [59, 60]],
 'roof_rows': 0,
 'roof_cycle': [0, 0],
 'slab': 0,
 'depth_px': 24,
 ...
 'seal': 'e',
 'tileset': 'ship'},
    'ship_kitchen_counter': {'tiles': [[10, 10, 10, 10], [44, 64, 65, 44], [44, 80, 81, 44], [44, 44, 26, 44]],
 'roof_rows': 0,
 'roof_cycle': [0, 0],
 'slab': 0,
 'depth_px': 32,
 ...
 'parts': [{'kind': 'flat',
            ...
            'thick': 12,
            'sample': [2, 8]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [0, 31], 'z': 0, 'at': 11},
           {'kind': 'flat',
            'x': [16, 23],
            'rows': [0, 7],
            'z': 24,
 ...
 'seal': 'nsew',
 'tileset': 'ship'},
    'ship_kitchen_hob': {'tiles': [[10, 10, 10, 10], [44, 53, 53, 44], [44, 53, 53, 44], [44, 44, 44, 44]],
 'roof_rows': 0,
 'roof_cycle': [0, 0],
 'slab': 0,
 'depth_px': 32,
 'panes': False,
 'ground_tiles': [[13, 29], [29, 13]],
 'parts': [{'kind': 'flat', 'x': [0, 31], 'rows': [0, 31], 'z': 0, 'at': 11, 'thick': 12, 'sample': [2, 8]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [0, 31], 'z': 0, 'at': 11}],
 'seal': 'nsew',
 'tileset': 'ship'},
    'ship_captain_chair': {'tiles': [[16, 16], [84, 85], [66, 67], [23, 24]],
 'roof_rows': 0,
 'roof_cycle': [0, 0],
 'slab': 0,
 'depth_px': 32,
 'panes': False,
 'ground_tiles': [[13, 29], [29, 13]],
 'parts': [{'kind': 'flat', 'x': [0, 15], 'rows': [1, 16], 'z': 0, 'at': 15, 'thick': 16, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 15, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 14, 'sample': [0, 1]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 13, 'sample': [0, 2]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 12, 'sample': [0, 3]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 11, 'sample': [0, 4]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 10, 'sample': [0, 5]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 9, 'sample': [0, 6]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 8, 'sample': [0, 7]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 7, 'sample': [0, 8]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 6, 'sample': [0, 9]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 5, 'sample': [0, 10]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 4, 'sample': [0, 11]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 3, 'sample': [0, 12]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 2, 'sample': [0, 13]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 1, 'sample': [0, 14]},
           {'kind': 'flat', 'x': [0, 15], 'rows': [0, 0], 'z': 15, 'at': 0, 'sample': [0, 15]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 19, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 20, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 21, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 22, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 23, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 24, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 25, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 26, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 27, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 28, 'at': 0, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 20, 'at': 0, 'sample': [5, 28]},
           ...
           {'kind': 'flat', 'x': [7, 8], 'rows': [1, 2], 'z': 23, 'at': 1, 'sample': [7, 29]},
           {'kind': 'flat', 'x': [7, 8], 'rows': [1, 2], 'z': 23, 'at': 2, 'sample': [5, 28]},
           {'kind': 'flat', 'x': [7, 8], 'rows': [1, 2], 'z': 23, 'at': 3, 'sample': [5, 28]},
           {'kind': 'flat', 'x': [7, 8], 'rows': [1, 2], 'z': 23, 'at': 4, 'sample': [7, 27]},
           {'kind': 'flat', 'x': [6, 9], 'rows': [0, 0], 'z': 20, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 21, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 22, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 23, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 24, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 25, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 26, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [6, 9], 'rows': [0, 0], 'z': 27, 'at': 5, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 19, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 20, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 21, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 22, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 23, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 24, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 25, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 26, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 27, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 28, 'at': 6, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 18, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 19, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 20, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 21, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 22, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 23, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 24, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 25, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 26, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [2, 13], 'rows': [0, 0], 'z': 27, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 28, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 29, 'at': 7, 'sample': [3, 19]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 19, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 20, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 21, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 22, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 23, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 24, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 25, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [3, 12], 'rows': [0, 0], 'z': 26, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 27, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [5, 10], 'rows': [0, 0], 'z': 28, 'at': 7, 'sample': [3, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 20, 'at': 7, 'sample': [4, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 21, 'at': 7, 'sample': [4, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 22, 'at': 7, 'sample': [4, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 23, 'at': 7, 'sample': [4, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 24, 'at': 7, 'sample': [4, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 25, 'at': 7, 'sample': [4, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 26, 'at': 7, 'sample': [4, 20]},
           {'kind': 'flat', 'x': [4, 11], 'rows': [0, 0], 'z': 27, 'at': 7, 'sample': [4, 20]},
           {'kind': 'upright',
            'x': [3, 12],
            'top': [9, 9],
            'facade': [9, 18],
            ...
            'depth': 2,
            'case': {'sample': [4, 11]}},
           {'kind': 'flat', 'x': [4, 11], 'rows': [1, 2], 'z': 18, 'at': 18, 'sample': [4, 8]}],
 'seal': 'nsew',
 'tileset': 'ship'},
    'ship_truncated_table': {'tiles': [[9, 10, 10, 12], [25, 26, 44, 28]],
 'roof_rows': 0,
 'roof_cycle': [0, 0],
 'slab': 0,
 'depth_px': 17,
 'panes': False,
 'ground_tiles': [[13, 29], [29, 13]],
 'parts': [{'kind': 'flat', 'x': [0, 31], 'rows': [8, 23], 'z': 0, 'at': 11},
           {'kind': 'flat', 'x': [0, 31], 'rows': [0, 0], 'z': 16, 'at': 11},
           {'kind': 'flat', 'x': [0, 0], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 8]},
           {'kind': 'flat', 'x': [31, 31], 'rows': [1, 1], 'z': 0, 'at': 11, 'sample': [1, 8]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 0, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 1, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 2, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 3, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 4, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 5, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 6, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 7, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 8, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 9, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 10, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 11, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 12, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 13, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 14, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 15, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 16, 'at': 10, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 0, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 1, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 2, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 3, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 4, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 5, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 6, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 7, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 8, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 9, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 10, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 11, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 12, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 13, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 14, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 15, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [0, 31], 'rows': [1, 1], 'z': 16, 'at': 9, 'sample': [0, 0]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 2, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 3, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 4, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 5, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 11, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 12, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 13, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat', 'x': [2, 5], 'rows': [1, 1], 'z': 14, 'at': 8, 'thick': 9, 'sample': [1, 1]},
           {'kind': 'flat',
            'x': [26, 29],
            'rows': [1, 1],
            'z': 2,
           ...
           {'kind': 'flat',
            ...
            'thick': 1,
            'sample': [10, 17]}],
 'top_rows': [[11, 11, 11, 11]],
 'seal': 's',
 'tileset': 'ship'},
    'facility_cabinet': {'tileset': 'facility',
 ...
 'parts': [{'kind': 'upright',
    ...
    'facility_palm': dict(tileset='facility', tiles=[[5,6],[21,22],[7,15],[23,31]], plant='facility_palm', roof_rows=0, roof_cycle=[0,0], slab=0, depth_px=32, panes=False, seal=''),
    'lab_workbench': {'ground_tiles': [[1, 38], [38, 1]], 'tiles': [[2, 3, 4, 5], [18, 19, 20, 21], [6, 7, 8, 9], [22, 23, 38, 1]],
 'roof_rows': 0,
 'roof_back': 0,
 'roof_front': 0,
 'roof_cycle': [0, 0],
 ...
 'parts': [{'kind': 'flat',
           ...
           {'kind': 'flat',
            ...
            'thick': 1,
            'sample': [8, 24]},
           {'kind': 'flat', 'x': [3, 15], 'rows': [3, 7], 'at': 12},
           {'kind': 'upright',
            'x': [4, 15],
            'top': [8, 12],
            'facade': [12, 13],
 ...
 'tileset': 'lab',
 'seal': ''},
    'warden_workbench': {'ground_tiles': [[1, 38], [38, 1]], 'tiles': [[64, 65, 65, 66], [80, 72, 73, 82], [6, 7, 8, 9], [22, 23, 38, 1]],
 'roof_rows': 0,
 'roof_back': 0,
 'roof_front': 0,
 'roof_cycle': [0, 0],
 ...
 'parts': [{'kind': 'flat',
           ...
           {'kind': 'upright',
            ...
            'depth': 4,
            'case': {'sample': [9, 9]},
            'inset': {'x': [10, 13], 'rows': [10, 11]}},
           {'kind': 'flat', 'x': [8, 16], 'rows': [13, 15], 'z': 10, 'at': 12},
           {'kind': 'flat', 'x': [19, 19], 'rows': [8, 8], 'at': 11},
           {'kind': 'flat', 'x': [18, 20], 'rows': [9, 9], 'at': 11},
           {'kind': 'flat', 'x': [17, 21], 'rows': [10, 10], 'at': 11},
           {'kind': 'flat', 'x': [16, 22], 'rows': [11, 11], 'at': 11},
           {'kind': 'flat', 'x': [16, 22], 'rows': [12, 12], 'at': 11},
           {'kind': 'flat', 'x': [17, 21], 'rows': [13, 13], 'at': 11},
           {'kind': 'flat', 'x': [18, 20], 'rows': [14, 14], 'at': 11},
           {'kind': 'flat', 'x': [19, 19], 'rows': [15, 15], 'at': 11}],
 'tileset': 'lab',
 'seal': ''},
    'mansion_workbench': {'ground_tiles': [[17]], 'tiles': [[36, 37, 52, 53], [64, 65, 66, 67], [2, 3, 85, 86], [18, 19, 17, 17]],
 'roof_rows': 0,
 'roof_back': 0,
 'roof_front': 0,
 'roof_cycle': [0, 0],
 ...
 'seal': ''},
    ...
    'reds_pc': {'roof_rows': 0,
     ...
     'support': 12,
     'desk': {'fascia': [20, 22], 'base': [23, 31], 'depth': 2, 'lid': 'white', 'z': 16},
     'wall': {'cycle': [0, 3], 'h': 16, 'depth_px': 8, 'x': 0},
     'parts': [{'kind': 'upright',
                'x': [2, 13],
                'top': [0, 3],
                'facade': [4, 14],
                ...
                'depth': 6,
                'case': {'sample': [3, 1]},
                'inset': {'x': [4, 11], 'rows': [5, 10]}},
               {'kind': 'flat', 'x': [3, 12], 'rows': [17, 20], 'z': 24, 'at': 12},
               {'kind': 'flat', 'x': [1, 14], 'rows': [15, 15], 'z': 30, 'at': 11}],
     'tileset': 'reds_house'},
    ...
    'reds_short_table': {'roof_rows': 0,
     ...
     'front_eave': 0,
     'panes': False,
     'tiles': [[38, 39, 39, 41], [44, 42, 42, 43], [60, 58, 58, 59]],
     'support': 12,
     'parts': [{'kind': 'flat',
                'x': [2, 4],
                'rows': [19, 21],
               ...
               {'kind': 'flat',
                ...
                'sample': [3, 21],
                'thick': 8},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 14], 'z': 2, 'at': 8, 'sample': [15, 19]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 8], 'z': 15, 'at': 8, 'sample': [15, 19]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 0,
               ...
               {'kind': 'flat',
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 1, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 2,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 2, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 2, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 3,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 3, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 3, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 4,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 4, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 4, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 5,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 5, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 5, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 6,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 6, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 6, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 7,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 7, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 7, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 8,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 8, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 8, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 9,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 9, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 9, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 10,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 10, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 10, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 11,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 11, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 11, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 12,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 12, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 12, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 13,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 13, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 13, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 14,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 14, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 14, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 15,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 15, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 15, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 16,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 16, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 16, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 17,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 17, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 17, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 18,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 18, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 18, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 19,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 19, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 19, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 20,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 20, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 20, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 21,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 21, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat', 'x': [2, 29], 'rows': [2, 2], 'z': 21, 'at': 11, 'sample': [15, 3]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 22,
                ...
                'sample': [0, 2],
                'thick': 3},
               {'kind': 'flat', 'x': [1, 30], 'rows': [2, 2], 'z': 22, 'at': 11, 'sample': [15, 1]},
               {'kind': 'flat',
                'x': [0, 31],
                'rows': [2, 2],
                'z': 23,
    ...
    'beach_stool': {'roof_rows': 0,
     ...
     'panes': False,
     'tiles': [[2, 3], [18, 19]],
     'parts': [{'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 4, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 4, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 5, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 5, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 6, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 6, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 7, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 7, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 8, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 8, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 9, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 9, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 10, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 10, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 11, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 11, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [12, 12], 'z': 12, 'at': 1, 'sample': [5, 12]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [14, 14], 'z': 12, 'at': 0, 'sample': [5, 14]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 3, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 4, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 5, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 6, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 7, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 8, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 9, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 10, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 11, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 12, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [7, 7], 'z': 13, 'at': 2, 'sample': [2, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 4, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 5, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 6, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 7, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 8, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 9, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 10, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 11, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [7, 7], 'z': 12, 'at': 2, 'sample': [3, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [7, 7], 'z': 5, 'at': 2, 'sample': [4, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [7, 7], 'z': 6, 'at': 2, 'sample': [4, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [7, 7], 'z': 7, 'at': 2, 'sample': [4, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [7, 7], 'z': 8, 'at': 2, 'sample': [4, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [7, 7], 'z': 9, 'at': 2, 'sample': [4, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [7, 7], 'z': 10, 'at': 2, 'sample': [4, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [7, 7], 'z': 11, 'at': 2, 'sample': [4, 7]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [7, 7], 'z': 6, 'at': 2, 'sample': [5, 7]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [7, 7], 'z': 7, 'at': 2, 'sample': [5, 7]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [7, 7], 'z': 8, 'at': 2, 'sample': [5, 7]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [7, 7], 'z': 9, 'at': 2, 'sample': [5, 7]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [7, 7], 'z': 10, 'at': 2, 'sample': [5, 7]}],
     'tileset': 'beach_house'},
    'beach_table': {'roof_rows': 0,
     'roof_back': 0,
     'roof_front': 0,
     'roof_cycle': [0, 0],
     'slab': 0,
     ...
     'parts': [{'kind': 'upright',
               ...
               {'kind': 'upright',
                ...
                'z': 0,
                'depth': 32},
               {'kind': 'flat', 'x': [0, 31], 'rows': [24, 24], 'z': 0, 'at': 5},
               {'kind': 'flat', 'x': [1, 30], 'rows': [1, 1], 'z': 1, 'at': 5},
               {'kind': 'upright',
                'x': [30, 30],
                'top': [1, 1],
                'facade': [1, 1],
                ...
                'z': 1,
                'depth': 30},
               {'kind': 'flat', 'x': [1, 30], 'rows': [1, 1], 'z': 30, 'at': 5},
               {'kind': 'flat', 'x': [13, 18], 'rows': [8, 8], 'z': 12, 'at': 5},
               {'kind': 'flat', 'x': [12, 19], 'rows': [9, 9], 'z': 13, 'at': 5},
               {'kind': 'flat', 'x': [11, 20], 'rows': [10, 10], 'z': 14, 'at': 5},
               {'kind': 'flat', 'x': [11, 20], 'rows': [11, 11], 'z': 15, 'at': 5},
               {'kind': 'flat', 'x': [11, 20], 'rows': [12, 12], 'z': 16, 'at': 5},
               {'kind': 'flat', 'x': [11, 20], 'rows': [13, 13], 'z': 17, 'at': 5},
               {'kind': 'flat', 'x': [12, 19], 'rows': [14, 14], 'z': 18, 'at': 5},
               {'kind': 'flat', 'x': [13, 18], 'rows': [15, 15], 'z': 19, 'at': 5}],
     'tileset': 'beach_house'},
    'beach_pc': {'roof_rows': 0,
     'roof_back': 0,
     'roof_front': 0,
     'roof_cycle': [0, 0],
     'slab': 0,
    ...
    'cable_club_stool': {'roof_rows': 0,
     ...
     'panes': False,
     'tiles': [[42, 43], [38, 39]],
     'parts': [{'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 2, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 3, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 4, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 5, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 6, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 7, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 8, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 9, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 10, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 11, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 12, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 13, 'at': 5, 'sample': [7, 4]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 3, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 4, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 5, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 6, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 7, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 8, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 9, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 10, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 11, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 12, 'at': 5, 'sample': [7, 5]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 4, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 5, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 6, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 7, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 8, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 9, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 10, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 11, 'at': 5, 'sample': [7, 7]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 2, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 3, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 4, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 5, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 6, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 7, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 8, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 9, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [2, 13], 'rows': [8, 8], 'z': 10, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 11, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 12, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 13, 'at': 4, 'sample': [5, 11]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 3, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 4, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 5, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 6, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 7, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 8, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 9, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [3, 12], 'rows': [8, 8], 'z': 10, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 11, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 12, 'at': 3, 'sample': [7, 13]},
               {'kind': 'flat', 'x': [6, 9], 'rows': [8, 8], 'z': 4, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 5, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 6, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 7, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 8, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [4, 11], 'rows': [8, 8], 'z': 9, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 10, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [6, 9], 'rows': [8, 8], 'z': 11, 'at': 2, 'thick': 3, 'sample': [5, 15]},
               {'kind': 'flat', 'x': [6, 9], 'rows': [8, 8], 'z': 5, 'at': 2, 'thick': 2, 'sample': [7, 14]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 6, 'at': 2, 'thick': 2, 'sample': [7, 14]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 7, 'at': 2, 'thick': 2, 'sample': [7, 14]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 8, 'at': 2, 'thick': 2, 'sample': [7, 14]},
               {'kind': 'flat', 'x': [5, 10], 'rows': [8, 8], 'z': 9, 'at': 2, 'thick': 2, 'sample': [7, 14]},
               {'kind': 'flat', 'x': [6, 9], 'rows': [8, 8], 'z': 10, 'at': 2, 'thick': 2, 'sample': [7, 14]}],
     'tileset': 'club'},
    "lobby_round_table": {'tiles': [[9, 39, 39, 25], [54, 55, 55, 57], [70, 55, 55, 71], [85, 86, 87, 55]],
 'roof_rows': 0,
 'roof_back': 0,
 'roof_front': 0,
 'roof_cycle': [0, 0],
 ...
 'front_eave': 0,
 'panes': False,
 'parts': [{'kind': 'flat', 'x': [13, 18], 'rows': [7, 7], 'z': 8, 'at': 1, 'thick': 2, 'sample': [15, 25]},
 ...
 'ledge': None},
    'lobby_stool': {'roof_rows': 0,
     ...
     'parts': [{'kind': 'upright',
                ...
                'stretch': True,
                'silhouette': False,
                'supports': {'from_row': 11,
                             'zones': [{'x': [3, 4], 'z': [5, 6]},
                                       {'x': [3, 4], 'z': [10, 11]},
                                       {'x': [11, 12], 'z': [5, 6]},
                                       {'x': [11, 12], 'z': [10, 11]}]}},
               {'kind': 'flat', 'x': [3, 12], 'rows': [4, 4], 'z': 13, 'at': 4},
               {'kind': 'flat', 'x': [3, 12], 'rows': [5, 5], 'z': 4, 'at': 4},
               {'kind': 'flat', 'x': [5, 10], 'rows': [6, 6], 'z': 6, 'at': 4},
               {'kind': 'flat', 'x': [5, 10], 'rows': [9, 9], 'z': 11, 'at': 4}],
     'tileset': 'lobby'},
    'museum_stool': {'roof_rows': 0,
     'roof_back': 0,
     'roof_front': 0,
     'roof_cycle': [0, 0],
     'slab': 0,
     ...
     'parts': [{'kind': 'upright',
                ...
                'supports': {'from_row': 12,
                             'zones': [{'x': [3, 4], 'z': [5, 6]},
                                       ...
                                       {'x': [11, 12], 'z': [5, 6]},
                                       {'x': [11, 12], 'z': [10, 11]}]}},
               {'kind': 'flat', 'x': [3, 12], 'rows': [5, 5], 'z': 13, 'at': 4},
               {'kind': 'flat', 'x': [3, 12], 'rows': [6, 6], 'z': 4, 'at': 4},
               {'kind': 'flat', 'x': [5, 10], 'rows': [7, 7], 'z': 6, 'at': 4},
               {'kind': 'flat', 'x': [5, 10], 'rows': [10, 10], 'z': 11, 'at': 4}],
     'tileset': 'gate'},
    # The complete LAB desk keeps its established12px support. Source
    # artwork becomes one raised terminal, one keyboard and one flat motif.
    "lab_equipment_desk": dict(
        tiles=[[64,65,65,66], [80,81,81,82], [80,72,73,82], [83,58,58,84]],
        tileset="lab", roof_rows=0, roof_back=0, roof_front=0, roof_cycle=(0,0),
        slab=0, front_eave=0, panes=False, support=12,
        parts=[
            dict(kind="flat", x=(2,4), rows=(28,30), z=2, at=8, thick=9),
            dict(kind="flat", x=(27,29), rows=(28,30), z=2, at=8, thick=9),
            dict(kind="flat", x=(2,4), rows=(28,30), z=27, at=8, thick=9),
            dict(kind="flat", x=(27,29), rows=(28,30), z=27, at=8, thick=9),
            # Plain source field on the lid, original display retained for
            # its upright part; do not scrub the composed source sprite.
            dict(kind="upright", x=(0,31), top=(2,2), facade=(24,26), rise=9, z=0, depth=32),
            dict(kind="upright", x=(0,31), top=(24,24), facade=(24,24), rise=9, z=0, depth=32),
            dict(kind="flat", x=(0,31), rows=(24,24), z=0, at=11),
            dict(kind="flat", x=(1,30), rows=(1,1), z=1, at=11),
            dict(kind="upright", x=(30,30), top=(1,1), facade=(1,1), rise=11, z=1, depth=30),
            dict(kind="flat", x=(1,30), rows=(1,1), z=30, at=11),
            dict(kind="upright", x=(8,16), top=(16,16), facade=(17,20), rise=12, z=16, depth=4,
                 case=dict(sample=(9,17)), inset=dict(x=(10,13), rows=(18,19))),
            dict(kind="flat", x=(8,16), rows=(21,23), z=20, at=12),
            # Exact32-pixel diamond; the rest of tile73 is plain tabletop.
            dict(kind="flat", x=(19,19), rows=(16,16), at=11),
            dict(kind="flat", x=(18,20), rows=(17,17), at=11),
            dict(kind="flat", x=(17,21), rows=(18,18), at=11),
            dict(kind="flat", x=(16,22), rows=(19,20), at=11),
            dict(kind="flat", x=(17,21), rows=(21,21), at=11),
            dict(kind="flat", x=(18,20), rows=(22,22), at=11),
            dict(kind="flat", x=(19,19), rows=(23,23), at=11),
        ],
    ),
    # Five rows of front leg elevation below the LAB stool's top-view
    # cushion: physical seat height6. Match the accepted centered rim
    # and four inset supports without copying the whole drawing upright.
    "lab_stool": dict(
        tiles=[[14, 15], [30, 31]], tileset="lab",
        roof_rows=0, roof_back=0, roof_front=0, roof_cycle=(0, 0),
        slab=0, front_eave=0, panes=False,
        parts=[
            dict(kind="upright", x=(2, 13), top=(2, 7), facade=(8, 13),
                 z=3, depth=11, stretch=True, silhouette=False,
                 supports=dict(from_row=9, zones=[
                     dict(x=(3, 4), z=(10, 11)),
                     dict(x=(11, 12), z=(10, 11)),
                     dict(x=(3, 4), z=(5, 6)),
                     dict(x=(11, 12), z=(5, 6)),
                 ])),
            # Continuous black rim, equal white margins, gray6x5 field.
            dict(kind="flat", x=(3, 12), rows=(2, 2), z=13, at=5),
            dict(kind="flat", x=(3, 12), rows=(3, 3), z=4, at=5),
            dict(kind="flat", x=(5, 10), rows=(4, 4), z=6, at=5),
            dict(kind="flat", x=(5, 10), rows=(7, 7), z=11, at=5),
        ],
    ),
 ...
 'front_eave': 0,
 'panes': False,
 'parts': [{'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 2},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 3},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 4},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 5},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 2},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 3},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 4},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 5},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 10},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 11},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 12},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 13},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 10},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 11},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 12},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 13},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 2},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 3},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 4},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 5},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 2},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 3},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 4},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 5},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 10},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 11},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 12},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [42, 45], 'z': 13},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 10},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 11},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 12},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [42, 45], 'z': 13},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 2},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 3},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 4},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 5},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 6},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 7},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 8},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 9},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 10},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 11},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 12},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 45], 'z': 13},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 0},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 1},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 13},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 14},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 47], 'z': 15},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 0},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 1},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 2},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 3},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 4},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 5},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 6},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 7},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 8},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 9},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 10},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 11},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 12},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 13},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 14},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 47], 'z': 15},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 1},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 13},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 46], 'z': 14},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 45], 'z': 13}],
 'roof_back': 16,
 'roof_cycle': [2, 13],
 'roof_front': 0,
 'roof_rows': 19,
 'slab': 3,
 'tiles': [[41, 59, 59, 59, 59, 42], [78, 57, 57, 57, 57, 79], [88, 89, 89, 89, 89, 90]],
 'tileset': 'gym'},
 ...
 'parts': [{'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 2},
           ...
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 12},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [2, 5], 'z': 13},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 2},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 3},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 4},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 5},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 2},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 3},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 4},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 5},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 10},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 11},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 12},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [26, 29], 'z': 13},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 10},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 11},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 12},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [26, 29], 'z': 13},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 2},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 3},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 4},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 5},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 6},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 7},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 8},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 9},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 10},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 11},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 12},
           {'at': 2, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 1, 'x': [2, 29], 'z': 13},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 0},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 1},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 13},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 14},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 3, 'x': [0, 31], 'z': 15},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 0},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 1},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 2},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 3},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 4},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 5},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 6},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 7},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 8},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 9},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 10},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 11},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 12},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 13},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 14},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 15},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 1},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 13},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 1], 'thick': 1, 'x': [1, 30], 'z': 14},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [3, 3], 'thick': 1, 'x': [2, 29], 'z': 13},
           {'case': {'sample': [3, 1]},
            'depth': 4,
            'facade': [3, 10],
            'kind': 'upright',
            ...
            'top': [0, 2],
            'x': [2, 13]},
           {'at': 6, 'kind': 'flat', 'rows': [11, 14], 'x': [1, 13]},
           {'case': {'sample': [15, 1]},
            'depth': 6,
            'facade': [4, 10],
            'kind': 'upright',
            ...
            'top': [0, 3],
            'x': [14, 21]},
           {'at': 6, 'kind': 'flat', 'rows': [11, 14], 'x': [14, 21]},
           {'at': 6, 'kind': 'flat', 'rows': [1, 14], 'x': [22, 30]}],
 'roof_back': 0,
 'roof_cycle': [0, 0],
 'roof_front': 0,
 'roof_rows': 0,
 'slab': 0,
 'tiles': [[91, 92, 93, 94], [54, 55, 85, 95], [88, 89, 89, 90]],
 'tileset': 'gym'},
    # F03: the empty north table beside it -- the starter table's band
    # table verbatim on a grid two tiles narrower (one placement).
    'lab_table_small': {'depth': 2,
 'front_eave': 0,
 'panes': False,
 'parts': [{'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 2},
           {'at': 1, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 16], 'thick': 2, 'x': [2, 5], 'z': 3},
           ...
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 14},
           {'at': 4, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 17], 'thick': 1, 'x': [0, 31], 'z': 15},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 1},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 13},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 1], 'thick': 1, 'x': [1, 30], 'z': 14},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 2},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 3},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 4},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 5},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 6},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 7},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 8},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 9},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 10},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 11},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 12},
           {'at': 5, 'kind': 'flat', 'rows': [17, 17], 'sample': [8, 2], 'thick': 1, 'x': [2, 29], 'z': 13}],
 'roof_back': 16,
 'roof_cycle': [2, 13],
 'roof_front': 0,
 'roof_rows': 19,
 'slab': 3,
 'tiles': [[41, 59, 59, 42], [78, 57, 57, 79], [88, 89, 89, 90]],
 'tileset': 'gym'},
    ...
    "mansion_long_table": dict(
        ...
        # Level full-width slab, two-pixel overhang, original source bands.
        panes=False,
        parts=[
            dict(kind="upright", x=(2, 61), top=(28, 28), facade=(28, 30),
                 z=2, depth=28, supports=dict(from_row=29, zones=[
                     dict(x=(2, 5), z=(2, 5)),
                     dict(x=(2, 5), z=(26, 29)),
                     dict(x=(58, 61), z=(2, 5)),
                     dict(x=(58, 61), z=(26, 29)),
                 ])),                                      # apron/feet
            dict(kind="upright", x=(0, 63), top=(0, 23), facade=(24, 26),
                 rise=3, z=0, depth=32),                    # slab
            dict(kind="upright", x=(0, 63), top=(24, 24), facade=(24, 24),
                 rise=3, z=0, depth=32),                    # lower fascia
            dict(kind="upright", x=(62, 62), top=(1, 1), facade=(1, 1),
                 rise=5, z=1, depth=30),                    # white east rim
            dict(kind="flat", x=(1, 62), rows=(1, 1), z=30, at=5),
        ],
    ),
    ...
    "house_table": dict(
        ...
        panes=False,
        parts=[
            dict(kind="upright", x=(2, 29), top=(28, 28), facade=(28, 30),
                 z=2, depth=28, supports=dict(from_row=29, zones=[
                     dict(x=(2, 5), z=(2, 5)),
                     dict(x=(2, 5), z=(26, 29)),
                     dict(x=(26, 29), z=(2, 5)),
                     dict(x=(26, 29), z=(26, 29)),
                 ])),                                      # apron/feet
            dict(kind="upright", x=(0, 31), top=(0, 23), facade=(24, 26),
                 rise=3, z=0, depth=32),                    # slab
            dict(kind="upright", x=(0, 31), top=(24, 24), facade=(24, 24),
                 rise=3, z=0, depth=32),                    # lower fascia
            dict(kind="upright", x=(30, 30), top=(1, 1), facade=(1, 1),
                 rise=5, z=1, depth=30),                    # white east rim
            dict(kind="flat", x=(1, 30), rows=(1, 1), z=30, at=5),
        ],
    ),
    ...
    "reds_house_table": dict(
        ...
        parts=[
            ...
            dict(kind="upright", x=(0, 31), top=(0, 22), facade=(24, 26),
                 rise=3, z=0, depth=32),                    # slab
            dict(kind="upright", x=(0, 31), top=(24, 24), facade=(24, 24),
                 rise=3, z=0, depth=32),                    # lower fascia
            dict(kind="upright", x=(30, 30), top=(1, 1), facade=(1, 1),
    ...
    # Round cabin / Badge House stool: concentric cushion layers with drawn
    # widths 12/10/8, a centered field and separate dark fascia.
    # Mirror the unobscured lower foot outline into a ten-pixel round plan;
    # use its white field beneath the shaft instead of the junction marks.
    # The original 2x2 shaft, source palette/UV donors and height 8 remain.
    # Only the ordinary 7/8 seat matches, not the captain's 66/67 variant.
    "ship_stool": dict(
        tiles=[[7, 8], [23, 24]],
        roof_rows=0, roof_back=0, roof_front=0, roof_cycle=(0, 0),
        slab=0, front_eave=0, ledge=None, tileset="ship", panes=False,
        parts=[
            dict(kind="upright", x=(4, 11), top=(2, 2), facade=(2, 2), rise=7, z=2, depth=1),
            dict(kind="upright", x=(4, 11), top=(2, 2), facade=(2, 2), rise=7, z=13, depth=1),
            dict(kind="upright", x=(3, 12), top=(3, 3), facade=(3, 3), rise=7, z=3, depth=1),
            dict(kind="upright", x=(3, 12), top=(3, 3), facade=(3, 3), rise=7, z=12, depth=1),
            dict(kind="upright", x=(2, 13), top=(4, 4), facade=(4, 4), rise=7, z=4, depth=8),
            dict(kind="upright", x=(4, 11), top=(8, 8), facade=(8, 8), rise=7, z=3, depth=1),
            dict(kind="upright", x=(4, 11), top=(8, 8), facade=(8, 8), rise=7, z=12, depth=1),
            dict(kind="upright", x=(5, 10), top=(8, 8), facade=(8, 8), rise=6, z=3, depth=1),
            dict(kind="upright", x=(5, 10), top=(8, 8), facade=(8, 8), rise=6, z=12, depth=1),
            dict(kind="upright", x=(4, 11), top=(8, 8), facade=(8, 8), rise=6, z=4, depth=1),
            dict(kind="upright", x=(4, 11), top=(8, 8), facade=(8, 8), rise=6, z=11, depth=1),
            dict(kind="upright", x=(3, 12), top=(8, 8), facade=(8, 8), rise=6, z=5, depth=6),
            dict(kind="upright", x=(6, 9), top=(10, 10), facade=(10, 10), rise=5, z=4, depth=1),
            dict(kind="upright", x=(6, 9), top=(10, 10), facade=(10, 10), rise=5, z=11, depth=1),
            dict(kind="upright", x=(5, 10), top=(10, 10), facade=(10, 10), rise=5, z=5, depth=1),
            dict(kind="upright", x=(5, 10), top=(10, 10), facade=(10, 10), rise=5, z=10, depth=1),
            dict(kind="upright", x=(4, 11), top=(10, 10), facade=(10, 10), rise=5, z=6, depth=4),
            dict(kind="box", x=(7, 8), rows=(11, 13), cycle=(12, 12), base=1, z=7, depth=2),
            dict(kind="upright", x=(5, 10), top=(15, 15), facade=(15, 15), rise=0, z=3, depth=1),
            dict(kind="upright", x=(5, 10), top=(15, 15), facade=(15, 15), rise=0, z=12, depth=1),
            dict(kind="upright", x=(4, 11), top=(14, 14), facade=(14, 14), rise=0, z=4, depth=1),
            dict(kind="upright", x=(4, 11), top=(14, 14), facade=(14, 14), rise=0, z=11, depth=1),
            dict(kind="upright", x=(3, 12), top=(13, 13), facade=(13, 13), rise=0, z=5, depth=6),
            dict(kind="upright", x=(7, 8), top=(14, 14), facade=(14, 14), rise=0, z=5, depth=6),
        ],
    ),
    # F09: the stool at every one of those tables -- the first template
    # with NO base piece. The drawing is one object, a seat on
    ...
    "house_stool": dict(
        ...
        parts=[
            dict(kind="upright", x=(2, 13), top=(5, 10), facade=(11, 15),
                 # Fill the four missing corners with the source black
                 # rim; preserve the seat art and accepted inset legs.
                 z=3, depth=11, stretch=True, silhouette=False,
                 # Four corner legs repeat the drawn outer pair. The
                 # dark middle is shaded space, not another solid foot.
                 # Solid2x2 posts sit inside the seat rim, with
                 # overhang on both axes; leave the space between open.
                 supports=dict(from_row=12, zones=[
                     dict(x=(3, 4), z=(10, 11)),
                     dict(x=(11, 12), z=(10, 11)),
                     dict(x=(3, 4), z=(5, 6)),
                     dict(x=(11, 12), z=(5, 6)),
                 ])),                                       # the stool
            # Reuse the original black rim on the far edge's ten voxels.
            dict(kind="flat", x=(3, 12), rows=(5, 5), z=13, at=4),
            # Equal two-pixel white margins, centered six-by-five field.
            dict(kind="flat", x=(3, 12), rows=(6, 6), z=4, at=4),
            dict(kind="flat", x=(5, 10), rows=(7, 7), z=6, at=4),
            dict(kind="flat", x=(5, 10), rows=(10, 10), z=11, at=4),
        ],
    ),
    ...
    # same object band for band: the seat's front edge and apron, then
    # the two outer feet. Central shadow marks differ from the house
    # drawing. It keeps the two-voxel growth north and south.
    #
    ...
    "club_stool": dict(
        ...
        parts=[
            dict(kind="upright", x=(2, 13), top=(5, 10), facade=(11, 15),
                 ...
                 # rim; preserve the seat art and accepted inset legs.
                 z=3, depth=11, stretch=True, silhouette=False,
                 # Match the house stools: one-layer seat, inset2x2 posts.
                 supports=dict(from_row=12, zones=[
                     dict(x=(3, 4), z=(10, 11)),
                     dict(x=(11, 12), z=(10, 11)),
                     dict(x=(3, 4), z=(5, 6)),
            ...
            # Reuse the original black rim on the far edge's ten voxels.
            dict(kind="flat", x=(3, 12), rows=(5, 5), z=13, at=4),
            # Keep this source's one-pixel white inset on every side.
            dict(kind="flat", x=(3, 12), rows=(6, 6), z=4, at=4),
            dict(kind="flat", x=(4, 11), rows=(7, 7), z=5, at=4),
            dict(kind="flat", x=(4, 11), rows=(7, 7), z=6, at=4),
        ],
    ),
    ...
    "center_pc": dict(
        ...
        parts=[
            dict(kind="upright", x=(2, 13), top=(0, 3), facade=(4, 14),
                 depth=6, case=dict(sample=(3, 1))),                                   # the unit
    ...
    "bill_pipe_link": dict(
        pipe="bill_pipe", pipe_variant="link", tileset="interior",
        tiles=[[37, 38, 38, 38, 38, 32], [53, 54, 54, 54, 54, 48]],
        roof_rows=0, roof_back=0, roof_front=0, roof_cycle=(0,0),
        slab=0, front_eave=0, ledge=None, depth=2, panes=False,
    ),
    "bill_pipe_left": dict(
        pipe="bill_pipe", pipe_variant="left", tileset="interior",
        tiles=[[32], [48]],
        roof_rows=0, roof_back=0, roof_front=0, roof_cycle=(0,0),
        slab=0, front_eave=0, ledge=None, depth=2, panes=False,
    ),
    "bill_pipe_right": dict(
        pipe="bill_pipe", pipe_variant="right", tileset="interior",
        tiles=[[37], [53]],
        roof_rows=0, roof_back=0, roof_front=0, roof_cycle=(0,0),
        slab=0, front_eave=0, ledge=None, depth=2, panes=False,
    ),
    "bill_transporter": dict(
        machine="bill_transporter", tileset="interior",
        tiles=[[7,8,9,10],[23,24,25,26],[39,40,41,42],
               [55,56,57,58],[80,1,2,15]],
        roof_rows=0, roof_back=0, roof_front=0, roof_cycle=(0,0),
        slab=0, front_eave=0, ledge=None, depth=5, panes=False,
    ),
    "bills_desk": dict(
        tiles=[
            [11, 12, 13, 14],
        ...
        parts=[
            ...
            dict(kind="iso", x=(19, 30), rows=(1, 13), plan=6, z=9,
                 case=dict(shell=(28, 5), lid=(25, 2), bezel=(20, 10),
                           screen=(21, 7), cursor=(24, 8))),
            # Floor stool: rows20-26 are its top-view seat;27-31 are the
            # Club stool's shared five-pixel seat/leg band. Preserve the
            # desk's pane rule and keep posts away from the front plane.
            dict(kind="upright", x=(2, 13), top=(20, 26), facade=(27, 31), rise=-8, z=20, depth=11, stretch=True, silhouette=False, supports=dict(from_row=28, zones=[dict(x=(3, 4), z=(22, 23)), dict(x=(11, 12), z=(22, 23)), dict(x=(3, 4), z=(27, 28)), dict(x=(11, 12), z=(27, 28))])),
            dict(kind="flat", x=(3, 12), rows=(20, 20), z=30, at=4),
            dict(kind="flat", x=(3, 12), rows=(21, 21), z=21, at=4),
            dict(kind="flat", x=(4, 11), rows=(22, 22), z=22, at=4),
            dict(kind="upright", x=(13, 13), top=(21, 21), facade=(21, 21), rise=-4, z=20, depth=2),
        ],
    ),
...
def sprite(tiles, seal="", tileset="overworld", scrub=None):
    ...
    if len(pal) < 4 and all(c in [(255,255,255),(170,170,170),(85,85,85),(0,0,0)] for c in pal):
...
# --------------------------------------------------------------- stage 3 --
def within_supports(supports, x, sy, z):
    """Drawn leg columns and elevation, authored front/back foot depths."""
    if not supports or sy < supports["from_row"]:
        return True
    return any(zone["x"][0] <= x <= zone["x"][1]
               and zone["z"][0] <= z <= zone["z"][1]
               for zone in supports["zones"])


def computer_case_surfaces(p, plane):
    """Independent planar CRT reference; each face samples original artwork.

    The voxel dictionary is an interior occlusion proxy. These small planar
    quads are the actual visible case, including the recessed display walls.
    """
    c = p["case"]
    n = (p["x"][1] - p["x"][0] + 1) // 2
    h = p["rows"][1] - 2 * (n // 2) - p["rows"][0] + 1
    faces = []

    def face(points, source, shade):
        faces.append(dict(points=[(p["x"][0] + u + v, plane + y,
                                   p["z"] + u - v) for u, y, v in points],
                          source=tuple(source), shade=shade))

    def display(u, y):
        return 1 <= u < n - 1 and 2 <= y < h - 1

    r = 0.3
    for u in range(n):
        for y in range(h):
            screen = display(u, y)
            v = r if screen else 0
            color = c["screen"] if screen or y == 0 else c["bezel"]
            if screen and u == n - 2 and y == h - 3:
                color = c["cursor"]
            face([(u,y,v),(u+1,y,v),(u+1,y+1,v),(u,y+1,v)],color,0.9)
            if screen:
                if not display(u-1,y):
                    face([(u,y,0),(u,y,r),(u,y+1,r),(u,y+1,0)],c["bezel"],0.78)
                if not display(u+1,y):
                    face([(u+1,y,r),(u+1,y,0),(u+1,y+1,0),(u+1,y+1,r)],c["bezel"],0.78)
                if not display(u,y-1):
                    face([(u,y,0),(u+1,y,0),(u+1,y,r),(u,y,r)],c["bezel"],0.95)
                if not display(u,y+1):
                    face([(u,y+1,r),(u+1,y+1,r),(u+1,y+1,0),(u,y+1,0)],c["bezel"],0.68)
            face([(u+1,y,n),(u,y,n),(u,y+1,n),(u+1,y+1,n)],c["shell"],0.68)
    for v in range(n):
        for y in range(h):
            face([(0,y,v+1),(0,y,v),(0,y+1,v),(0,y+1,v+1)],c["shell"],0.68)
            face([(n,y,v),(n,y,v+1),(n,y+1,v+1),(n,y+1,v)],c["shell"],0.78)
    for u in range(n):
        for v in range(n):
            face([(u,h,v),(u+1,h,v),(u+1,h,v+1),(u,h,v+1)],c["lid"],0.95)
    return faces
    ...
    def build_parts(plane):
        for p in t["parts"]:
            ...
            if p["kind"] == "flat":
                ...
                sample = p.get("sample")
                if sample:
                    assert 0 <= sample[0] < W and 0 <= sample[1] < H and inside(*sample), "flat donor must belong to source artwork"
            ...
            if p["kind"] == "box":
                ...
                continue
            if p["kind"] == "iso" and p.get("case"):
                case_plane = plane + p.get("rise", 0)
                sp["surfaces"].extend(computer_case_surfaces(p, case_plane))
                # The angled CRT has planar render faces. Its conservative
                # proxy stays inside the case and supplies occlusion/contact.
                n = (x1 - x0 + 1) // 2
                h = p["rows"][1] - 2 * (n // 2) - p["rows"][0] + 1
                sx, sy = p["case"]["shell"]
                for x in range(x0, x1 + 1):
                    for z in range(p["z"] - n, p["z"] + n):
                        u = ((x + 0.5 - x0) + (z + 0.5 - p["z"])) / 2
                        v = ((x + 0.5 - x0) - (z + 0.5 - p["z"])) / 2
                        if 0.5 <= u <= n - 0.5 and 0.5 <= v <= n - 0.5:
                            for y in range(h):
                                put(x, case_plane + y, z, sx, sy)
                                sp["planar_cells"].add((x, case_plane + y, z))
                continue
            if p["kind"] == "iso":
            ...
            ins = p.get("inset")
            casing = p.get("case", {}).get("sample")
            if casing:
                assert inside(*casing), "case donor must belong to source artwork"

            def lid_row(z):
                if z == pz + pd - 1:
                    # The closing top outline may differ from the fascia.
                    return p.get("top_front", fr0)
                if p.get("stretch"):
                    return min(tr0 + ((z - pz) * (tr1 - tr0 + 1))
                               // (pd - 1), tr1)
                return min(tr0 + z - pz, tr1)

            def body_at(sx, sy, z):
                # Optional source-shaped seats retain their rounded plan
                # through the apron and supports as well as the lid.
                if p.get("silhouette") and not inside(sx, lid_row(z)):
                    return False
                return within_supports(p.get("supports"), sx, sy, z)
            ...
            for sx in range(x0, x1 + 1):
                ...
                for z in range(pz, pz + pd):
                    ...
                    if not 0 <= z < D:      # a part lives inside the plot
                        continue
                    put(sx, ytp, z, sx, p.get("top_front", fr0)
                        if z == pz + pd - 1 else sy)
                ...
                for sy in range(fr0 + 1, fr1 + 1):
                    ...
                    ix = interior(sx, sy, x0, x1)
                    for z in range(pz, pz + pd):
                        if not 0 <= z < D or not body_at(sx, sy, z):
                            continue
                        sunk = ((ins and ins["x"][0] <= sx <= ins["x"][1]
                                 and ins["rows"][0] <= sy <= ins["rows"][1])
                                or (sx, sy) in pr["recess"])
                        if z == pz + pd - 1:
                            if not sunk:
                                put(sx, y, z, sx, sy)
                        elif casing:
                            donor = (sx, sy) if sunk and z == pz + pd - 2 else casing
                            put(sx, y, z, *donor)
                        else:
...
def build(sp, pr, t):
    ...
    if t.get("bicycle"):
        ...
        path = os.path.join(os.path.dirname(__file__), "bicycle_voxels.py")
        module_spec = importlib.util.spec_from_file_location("bicycle_reference", path)
        module = importlib.util.module_from_spec(module_spec)
        module_spec.loader.exec_module(module)
        sp["surfaces"] = module.build(sp,t)
        sp["planar_cells"] = set()
        return {}
    if t.get("plant") == "facility_palm":
        import importlib.util
        path = os.path.join(os.path.dirname(__file__), "facility_palm.py")
        module_spec = importlib.util.spec_from_file_location("facility_palm_reference", path)
        module = importlib.util.module_from_spec(module_spec)
        module_spec.loader.exec_module(module)
        return module.build(sp)
    if t.get("pipe") == "bill_pipe":
        import importlib.util
        path = os.path.join(os.path.dirname(__file__), "bill_pipe.py")
        module_spec = importlib.util.spec_from_file_location("bill_pipe_reference", path)
        module = importlib.util.module_from_spec(module_spec)
        module_spec.loader.exec_module(module)
        sp["surfaces"] = module.build(sp,t)
        sp["planar_cells"] = set()
        return {}
    if t.get("machine") == "bill_transporter":
        import importlib.util
        path = os.path.join(os.path.dirname(__file__), "bill_machine.py")
        module_spec = importlib.util.spec_from_file_location("bill_machine_reference", path)
        module = importlib.util.module_from_spec(module_spec)
        module_spec.loader.exec_module(module)
        return module.build(sp)
    if t.get("parts"):
    ...
    for sy in range(t["roof_rows"], H):
        ...
        for sx in range(W):
            ...
            ix = interior(sx, sy)
            for z in range(D):
                if not within_supports(t.get("supports"), sx, sy, z):
                    continue
                if z == 0 or z == D - 1:
                    put(sx, y, z, sx, sy)
                else:
...
def verify(vox, sp, pr, t):
    ...
    if t.get("bicycle"):
        assert not vox and sp.get("surfaces"), "bicycle must have open component geometry"
        for face in sp["surfaces"]:
            for axis in (0,2):
                values = [p[axis] for p in face["points"]]
                assert max(values)-min(values) <= 8+1e-8, "bicycle face exceeds curve lattice"
        return set()
    if t.get("plant") == "facility_palm":
        assert len(vox) == 1350, "complete palm source/depth changed"
        assert min(y for x,y,z in vox) == 0 and max(y for x,y,z in vox) == 30
        assert {z for x,y,z in vox} == {25.5,26.5,27.5,28.5,29.5}
        return shell_of(vox)
    if t.get("pipe") == "bill_pipe":
        assert not vox, "tube must not retain the old wall skin"
        assert sp.get("surfaces"), "tube surface missing"
        for face in sp["surfaces"]:
            xs=[p[0] for p in face["points"]]
            assert max(xs)-min(xs) <= 8, "tube face exceeds curve lattice"
        return set()
    if t.get("machine") == "bill_transporter":
        assert max(y for x,y,z in vox) == 31, "chamber height changed"
        assert all(0 <= x < 32 and 0 <= y < 32 and 8 <= z < 40
                   for x,y,z in vox), "chamber escaped drawing plot"
        assert all((x,y,z) not in vox for x in range(8,24)
                   for y in range(18) for z in range(31,40)), "Bill exit obstructed"
        return shell_of(vox)
    if t.get("parts"):
...
def verify_desk_set(vox, pr, t):
    ...
    for p in t["parts"]:
        ...
        if p["kind"] == "flat":
        ...
        elif p["kind"] == "iso" and p.get("case"):
            case_plane = plane + p.get("rise", 0)
            n = (x1-x0+1)//2
            h = p["rows"][1]-2*(n//2)-p["rows"][0]+1
            for x in range(x0,x1+1):
                for z in range(p["z"]-n,p["z"]+n):
                    ...
                    v=((x+0.5-x0)-(z+0.5-p["z"]))/2
                    if 0.5 <= u <= n-0.5 and 0.5 <= v <= n-0.5:
                        tops[x,z]=max(tops.get((x,z),0),case_plane+h-1)
                        assert all((x,y,z) in vox for y in range(case_plane,case_plane+h)), "CRT proxy hole"
        elif p["kind"] == "iso":
            ...
            for x in range(x0, x1 + 1):
                for z in range(pz, pz + p["depth"]):
                    ...
                    if z == pz + p["depth"] - 1:
                        continue
                    # Inspect this part's own rise. A separate foot
                    # below a raised cushion must not count as a hole
                    # through the cushion's solid column.
                    ys = [y for y in range(plane + p.get("rise", 0), ytp + 1)
                          if (x, y, z) in vox]
                    assert ys == list(range(ys[0], ys[0] + len(ys))) \
...
def preview_planar(shell, vox, sp, name, out, flip, canvas, pad):
    """Painter preview of actual planar faces, never the hidden voxel proxy."""
    vx, vz = (-1, 1) if flip else (1, -1)
    facets = []
    hidden = sp.get("planar_cells", set())
    def add(points, color, shade):
        facets.append((points, tuple(int(v*shade) for v in sp["pal"][color])))
    for x,y,z in shell:
        if (x,y,z) in hidden:
            continue
        color = vox[x,y,z][0]
        if (x,y+1,z) not in vox:
            add([(x,y+1,z),(x+1,y+1,z),(x+1,y+1,z+1),(x,y+1,z+1)],color,0.95)
        if (x+vx,y,z) not in vox:
            xx=x+(vx>0)
            add([(xx,y,z),(xx,y,z+1),(xx,y+1,z+1),(xx,y+1,z)],color,0.78)
        if (x,y,z+vz) not in vox:
            zz=z+(vz>0)
            add([(x,y,zz),(x+1,y,zz),(x+1,y+1,zz),(x,y+1,zz)],color,0.9)
    for f in sp["surfaces"]:
        a,b,c=f["points"][:3]
        ab=[b[i]-a[i] for i in range(3)];ac=[c[i]-a[i] for i in range(3)]
        normal=(ab[1]*ac[2]-ab[2]*ac[1],ab[2]*ac[0]-ab[0]*ac[2],ab[0]*ac[1]-ab[1]*ac[0])
        if normal[0]*vx+normal[1]+normal[2]*vz > 1e-9:
            sx,sy=f["source"];add(f["points"],sp["col"][sy][sx],f["shade"])
    def screen(p):
        x,y,z=p;return 2*(vx*x-vz*z),vx*x+vz*z-2*y
    all_points=[screen(p) for points,color in facets for p in points]
    minx=min(x for x,y in all_points);maxx=max(x for x,y in all_points)
    miny=min(y for x,y in all_points);maxy=max(y for x,y in all_points)
    width,height=canvas
    scale=min((width-2*pad)/(maxx-minx),(height-2*pad)/(maxy-miny))
    ox=(width-scale*(maxx-minx))/2;oy=(height-scale*(maxy-miny))/2
    image=Image.new("RGB",canvas,(202,220,159));draw=ImageDraw.Draw(image)
    facets.sort(key=lambda f:sum(vx*x+y+vz*z for x,y,z in f[0])/len(f[0]))
    for points,color in facets:
        draw.polygon([(ox+(screen(p)[0]-minx)*scale,oy+(screen(p)[1]-miny)*scale) for p in points],fill=color)
    image.save(os.path.join(out,name))


def preview(shell, vox, sp, name, out, flip, canvas=(1700, 900), pad=20):
    if sp.get("surfaces"):
        return preview_planar(shell,vox,sp,name,out,flip,canvas,pad)
...
def main():
    ...
    for name, t in TEMPLATES.items():
        sp = sprite(t.get("top_rows", []) + t["tiles"], t.get("seal", ""), t.get("tileset", "overworld"),
                    t.get("scrub"))
        pr = profile(sp, t)
        vox = build(sp, pr, t)
